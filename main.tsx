        ...
        <div class="overflow-hidden w-screen h-screen relative">
          ...
          >
            ...
            <div class="mt-2 mb-6 text-center text-gray-600 font-light lowercase gap-y-1 flex flex-col select-none">
              <strong class="animate-fade-in-down animate-count-1 animate-duration-300 animate-delay-1000 animate-both text-base">dynamic edge-rendered icons</strong>
              <span class="animate-fade-in-down animate-count-1 animate-duration-300 animate-delay-1300 animate-both text-sm">sub-millisecond response time</span>
            </div>
            <a href="/" title={(new URL(BASE_URL).hostname)} class="inline-block mt-6 w-20 h-20 select-none text-gray-600 hover:text-gray-900 transition-colors ease-in duration-300 animate animate-fade-in-up animate-count-1 animate-delay-2000 animate-ease-in animate-both">
              <img id="icon-preview" src="/favicon.svg" alt={(new URL(BASE_URL).hostname)} width="80" class="animate animate-tada animate-count-1 animate-delay-4000 animate-both" />
            </a>
              ...
              {exampleIconSlugs // sort icons by length
                ...
                (<div>
                  <a
                    href={`#${icon}.svg`}
                    key={i + icon}
                    class={`flex flex-row place-items-center gap-2 my-2 animate animate-back-in-right animate-ease-out animate-both animate-count-1 animate-delay-${500 + (i * 125)}`}
                  >
