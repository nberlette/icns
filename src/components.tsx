...
export const App = ({ ...props }) => (
  <Wrapper>
    <div
      class="fixed inset w-screen h-screen -rotate-x-6 rotate-y-3 straighten-up !scale-150 -z-1 [-webkit-mask-image:radial-gradient(50%_50%_at_50%_50%,#ffff,#fff0_80%)] [mask-image:radial-gradient(50%_50%_at_50%_50%,#ffff,#fff0_80%)]"
